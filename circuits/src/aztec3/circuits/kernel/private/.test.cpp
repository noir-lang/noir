...
//     //***************************************************************************
//     // We can create a TxObject from some of the above data. Users must sign a TxObject in order to give permission
//     for
...
//     NativeOracle private_kernel_oracle = NativeOracle(db, escrow_contract_address, msg_sender,
//     msg_sender_private_key); OracleWrapper private_kernel_oracle_wrapper = OracleWrapper(private_kernel_composer,
//     private_kernel_oracle);
