...
//     const auto& is_static_call =
//     private_inputs.private_call.call_stack_item.public_inputs.call_context.is_static_call;
...
//     {
//         // TODO: we need to pass in UNPACKED stack data. I.e. the preimages of the call_stack_item hashes, so that
//         data
//         // in the stack can be validated as being correct. (e.g. call_contexts of calls made by the private_call
//         // currently being validated).

//         // So we'll need to ensure our test_apps return not only a PrivateCircuitPublicInputs object, but also an
//         object
...
//         // Update on this topic: I've created call_context_reconciliation_data, which allows the call_context to be
//         // efficiently unpacked from a call_stack_item_hash. We'll need some "functions calling functions" tests
//         cases
//         // to see how best to move this data around neatly.
//     }
...
//                                     start_contract_deployment_call_stack_length == 0 && start_l1_call_stack_length ==
//                                     0,
