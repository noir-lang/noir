...
template <class Field, class Getters, typename PolyContainer, bool turbo> class FixedBaseKernel {
  ...
  public:
                                            ...
                                            const size_t i = 0)
    {
        ...
        Field q_2_multiplicand = challenges.alpha_powers[1] * q_fixed_base;

        Field q_3_multiplicand = (w_1_omega - w_1) * delta * w_3_omega * challenges.alpha_powers[3] * q_fixed_base;
        Field T1 = delta * w_3_omega * w_2 * challenges.alpha_powers[2];
        q_3_multiplicand = q_3_multiplicand + (T1 + T1) * q_fixed_base;

        Field q_4_multiplicand;
                                                ...
                                                const size_t i = 0)
    {
        ...
        // accumulator_init_identity = α^4 * (w_4 - 1)(w_4 - 1 - w_3)
        T0 = w_4 - Field(1);
        T1 = T0 - w_3;
        ...
        gate_identity = gate_identity * q_fixed_base;
