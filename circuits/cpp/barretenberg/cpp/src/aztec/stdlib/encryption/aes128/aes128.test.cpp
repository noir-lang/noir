...
{
    typedef plonk::stdlib::field_t<waffle::UltraComposer> field_pt;
    typedef plonk::stdlib::witness_t<waffle::UltraComposer> witness_pt;
    ...
    waffle::UltraVerifier verifier = composer.create_verifier();
