...
TEST(misc_sha256, test_NIST_vector_one)
{
    ...
    expected.push_back(0x5D);
    expected.push_back(0xAE);
    expected.push_back(0x22);
    expected.push_back(0x23);
    expected.push_back(0xB0);
    expected.push_back(0x03);
    expected.push_back(0x61);
    expected.push_back(0xA3);
    expected.push_back(0x96);
    expected.push_back(0x17);
    expected.push_back(0x7A);
    expected.push_back(0x9C);
    expected.push_back(0xB4);
    expected.push_back(0x10);
    expected.push_back(0xFF);
    expected.push_back(0x61);
    expected.push_back(0xF2);
...
TEST(misc_sha256, test_NIST_vector_three)
{
    ...
    expected.push_back(0x68);
    expected.push_back(0x32);
    expected.push_back(0x57);
    expected.push_back(0x20);
    expected.push_back(0xaa);
    expected.push_back(0xbd);
    expected.push_back(0x7c);
    expected.push_back(0x82);
    expected.push_back(0xf3);
    expected.push_back(0x0f);
    expected.push_back(0x55);
    expected.push_back(0x4b);
    expected.push_back(0x31);
    expected.push_back(0x3d);
    expected.push_back(0x05);
    expected.push_back(0x70);
    expected.push_back(0xc9);
    expected.push_back(0x5a);
    expected.push_back(0xcc);
    expected.push_back(0xbb);
    expected.push_back(0x7d);
    expected.push_back(0xc4);
    expected.push_back(0xb5);
    expected.push_back(0xaa);
    expected.push_back(0xe1);
...
TEST(misc_sha256, test_NIST_vector_four)
{
    ...
    expected.push_back(0x5a);
    expected.push_back(0xf2);
    expected.push_back(0x6c);
    expected.push_back(0xe9);
    expected.push_back(0x3d);
    expected.push_back(0xbb);
    expected.push_back(0x94);
    expected.push_back(0x43);
    expected.push_back(0x3a);
    expected.push_back(0x0e);
    expected.push_back(0x0b);
    expected.push_back(0x2e);
    expected.push_back(0x11);
    expected.push_back(0x9d);
    expected.push_back(0x01);
    expected.push_back(0x4f);
    expected.push_back(0x8e);
    expected.push_back(0x7f);
    expected.push_back(0x65);
    expected.push_back(0xbd);
    expected.push_back(0x56);
    expected.push_back(0xc6);
    expected.push_back(0x1c);
    expected.push_back(0xcc);
    expected.push_back(0xcd);
    expected.push_back(0x95);
    expected.push_back(0x04);
...
{
    std::string input_str = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
                            "AAAAAAAAAAAAAAAAAAAA";
    input_str += "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
                 "AAAAAAAAA";
    input_str += "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
                 "AAAAAAAAA";
    input_str += "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
    ...
    expected.push_back(0xe6);
    expected.push_back(0x86);
    expected.push_back(0x82);
    expected.push_back(0x34);
    expected.push_back(0x89);
    ...
    expected.push_back(0x59);
    expected.push_back(0xb8);
    expected.push_back(0xb2);
    expected.push_back(0x39);
    expected.push_back(0x31);
    expected.push_back(0x8b);
    expected.push_back(0x63);
    expected.push_back(0x64);
    expected.push_back(0xf6);
    expected.push_back(0xdc);
