...
inline bridge_id create_bridge_id_witness(Composer& composer, uint256_t const& bridge_id)
{
    // constants
    ...
    return {
        bridge_contract_address_ct, num_output_notes_ct, input_asset_id_ct, output_asset_id_a_ct, output_asset_id_b_ct
    };
}
