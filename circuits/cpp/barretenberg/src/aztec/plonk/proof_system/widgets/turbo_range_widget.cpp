...
void ProverTurboRangeWidget::compute_opening_poly_contribution(const transcript::Transcript& transcript,
                                                               const bool use_linearisation)
{
    if (use_linearisation) {
        return;
...
template <typename Field, typename Group, typename Transcript>
void VerifierTurboRangeWidget<Field, Group, Transcript>::compute_batch_evaluation_contribution(
...
template <typename Field, typename Group, typename Transcript>
Field VerifierTurboRangeWidget<Field, Group, Transcript>::append_scalar_multiplication_inputs(
