                                                           ...
                                                           const transcript::Transcript& transcript)
{
    ...
    fr delta_1 = w_2_fft[i] - w_1_fft[i];
    fr delta_2 = w_3_fft[i] - w_2_fft[i];
    fr delta_3 = w_4_fft[i] - w_3_fft[i];
    fr delta_4 = w_1_fft[i + 4] - w_4_fft[i];
                                                         ...
                                                         barretenberg::polynomial& r)
{
    ...
    fr delta_1 = w_2_eval - w_1_eval;
    fr delta_2 = w_3_eval - w_2_eval;
    fr delta_3 = w_4_eval - w_3_eval;
    fr delta_4 = w_1_omega_eval - w_4_eval;
                                                                 ...
                                                                 const bool use_linearisation)
{
    ...
    fr nu_base = fr::serialize_from_buffer(&transcript.get_challenge_from_map("nu", "q_range")[0]);
    ...
    verification_key*, Field& batch_eval, const Transcript& transcript, const bool use_linearisation)
{
    ...
    Field nu_base = transcript.get_challenge_field_element_from_map("nu", "q_range");
    ...
    const bool use_linearisation)
{
    ...
    if (use_linearisation) {
        ...
        Field delta_1 = w_2_eval - w_1_eval;
        Field delta_2 = w_3_eval - w_2_eval;
        Field delta_3 = w_4_eval - w_3_eval;
        Field delta_4 = w_1_omega_eval - w_4_eval;
