...
namespace waffle {
template <typename Field, typename Group, typename Transcript> class VerifierGenPermSortWidget {
  public:
    inline VerifierGenPermSortWidget();
...
extern template class VerifierGenPermSortWidget<barretenberg::fr,
                                                barretenberg::g1::affine_element,
                                                transcript::StandardTranscript>;

class ProverGenPermSortWidget : public ProverBaseWidget {
  public:
    inline ProverGenPermSortWidget(proving_key* input_key, program_witness* input_witness);
    inline ProverGenPermSortWidget(const ProverGenPermSortWidget& other);
    inline ProverGenPermSortWidget(ProverGenPermSortWidget&& other);
    inline ProverGenPermSortWidget& operator=(const ProverGenPermSortWidget& other);
    inline ProverGenPermSortWidget& operator=(ProverGenPermSortWidget&& other);
...
#include "genperm_sort_widget_impl.hpp"