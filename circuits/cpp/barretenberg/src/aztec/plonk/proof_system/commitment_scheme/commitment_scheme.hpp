...
class CommitmentScheme {
  public:
    ...
    virtual void compute_opening_polynomial(const fr* src, fr* dest, const fr& z, const size_t n, std::string tag, fr item_constant, work_queue& queue) = 0;
    ...
    virtual void batch_open(const transcript::StandardTranscript& transcript, 
                              work_queue& queue, std::shared_ptr<proving_key> input_key = nullptr,  
    ...
    virtual void batch_verify(const transcript::StandardTranscript& transcript, 
                                ...
                                std::shared_ptr<verification_key> input_key = nullptr) = 0;
