...
class KateCommitmentScheme : public CommitmentScheme {
  public:
    ...
    void compute_opening_polynomial(const fr* src, fr* dest, const fr& z, const size_t n, std::string tag, fr item_constant, work_queue& queue) override;
