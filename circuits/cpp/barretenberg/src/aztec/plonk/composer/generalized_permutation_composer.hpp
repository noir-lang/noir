...
class GenPermComposer : public TurboComposer {
  public:
    ...
    virtual GenPermProver create_prover();
              ...
              transcript::Manifest::RoundManifest(
                  {
                      ...
                      { "q_arith", fr_size, false, 7 },   { "q_ecc_1", fr_size, false, 8 },
                      { "q_c", fr_size, false, 9 },       { "r", fr_size, false, 10 },
                      { "id_1", fr_size, false, 11 },     { "id_2", fr_size, false, 12 },
                      { "id_3", fr_size, false, 13 },     { "id_4", fr_size, false, 14 },
                      { "z_omega", fr_size, false, -1 },  { "w_1_omega", fr_size, false, 0 },
                      { "w_2_omega", fr_size, false, 1 }, { "w_3_omega", fr_size, false, 2 },
