...
// namespace {
// point_ct add_points(const point_ct& first, const point_ct& second)
// {
...
//  **/
// point_ct hash_single(const field_ct& in, const size_t hash_index, const bool validate_edge_cases = false)
// {
//     field_ct scalar = in;
...
// field_ct accumulate(std::vector<point_ct>& to_accumulate)
// {
//     if (to_accumulate.size() == 0) {
//         return field_ct(0);
//     }

//     point_ct accumulator = to_accumulate[0];
...
// field_ct conditionally_accumulate(std::vector<point_ct>& to_accumulate, std::vector<field_ct>& inputs)
// {
//     if (to_accumulate.size() == 0) {
//         return field_ct(0);
//     }
...
// {
//     std::vector<point_ct> accumulators;
...
// {
//     std::vector<point_ct> to_accumulate;
...
// point_ct compress_to_point(const field_ct& in_left, const field_ct& in_right, const size_t hash_index)
// {
//     point_ct first = hash_single(in_left, hash_index);
//     point_ct second = hash_single(in_right, hash_index + 1);
...
template <typename C> field_t<C> pedersen<C>::compress_eight(std::array<field_t, 8>& inputs, bool handle_edge_cases)
{
    std::vector<field_t> converted(inputs.begin(), inputs.end());
    return compress(converted, handle_edge_cases);
}
...
// template field_t<waffle::TurboComposer> compress_eight<waffle::TurboComposer>(
//     std::array<field_t<waffle::TurboComposer>, 8>&, bool);
// template field_t<waffle::PLookupComposer> compress_eight<waffle::PLookupComposer>(
//     std::array<field_t<waffle::PLookupComposer>, 8>&, bool);

// template field_t<waffle::TurboComposer> compress<waffle::TurboComposer>(std::vector<field_t<waffle::TurboComposer>>&,
//                                                                         bool);
// template field_t<waffle::PLookupComposer> compress<waffle::PLookupComposer>(
//     std::vector<field_t<waffle::PLookupComposer>>&, bool);

// template field_t<waffle::TurboComposer> compress<waffle::TurboComposer>(const field_t<waffle::TurboComposer>&,
//                                                                         const field_t<waffle::TurboComposer>&,
//                                                                         const size_t,
//                                                                         bool);
// template field_t<waffle::PLookupComposer> compress<waffle::PLookupComposer>(const field_t<waffle::PLookupComposer>&,
//                                                                             const field_t<waffle::PLookupComposer>&,
//                                                                             const size_t,
//                                                                             bool);

// template byte_array<waffle::TurboComposer> compress<waffle::TurboComposer>(const byte_array<waffle::TurboComposer>&);
// template byte_array<waffle::PLookupComposer> compress<waffle::PLookupComposer>(
