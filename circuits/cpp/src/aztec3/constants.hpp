...
constexpr size_t CONTRACT_COMMITMENTS_SUBTREE_HEIGHT = 1;
constexpr size_t CONTRACT_SUBTREE_INCLUSION_CHECK_DEPTH = CONTRACT_TREE_HEIGHT - CONTRACT_COMMITMENTS_SUBTREE_HEIGHT;

constexpr size_t PRIVATE_DATA_SUBTREE_HEIGHT = 3;
constexpr size_t PRIVATE_DATA_SUBTREE_INCLUSION_CHECK_DEPTH = NULLIFIER_TREE_HEIGHT - PRIVATE_DATA_SUBTREE_HEIGHT;

constexpr size_t NULLIFIER_SUBTREE_HEIGHT = 3;
constexpr size_t NULLIFIER_SUBTREE_INCLUSION_CHECK_DEPTH = NULLIFIER_TREE_HEIGHT - NULLIFIER_SUBTREE_HEIGHT;
