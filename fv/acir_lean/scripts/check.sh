...
bad=$(imports_outside AcirLean/Templates '^(Mathlib(\..*)?|AcirLean\.Spec\.Semantics)$')
[ -z "$bad" ] || fail "AcirLean/Templates imports modules other than Mathlib and Spec.Semantics: $bad"
