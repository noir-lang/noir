...
import { BaseContractInteraction, SendMethodOptions } from '../../contract/base_contract_interaction.js';
 ...
 */
export class LegacyDeployMethod<TContract extends ContractBase = Contract> extends BaseContractInteraction {
