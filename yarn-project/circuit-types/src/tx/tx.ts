...
export class Tx {
  constructor(
     ...
     */
    public readonly noteEncryptedLogs: EncryptedTxL2Logs,
    /**
  ...
  public static fromJSON(obj: any) {
    ...
    const noteEncryptedLogs = EncryptedTxL2Logs.fromBuffer(Buffer.from(obj.noteEncryptedLogs, 'hex'));
  ...
  static clone(tx: Tx): Tx {
    ...
    const noteEncryptedLogs = EncryptedTxL2Logs.fromBuffer(Buffer.from(tx.noteEncryptedLogs.toBuffer()));
