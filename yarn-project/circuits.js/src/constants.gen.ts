...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 428;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 481;
export const PRIVATE_CALL_STACK_ITEM_LENGTH = 431;
...
export const VALIDATION_REQUESTS_LENGTH = 1026;
...
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 3259;
