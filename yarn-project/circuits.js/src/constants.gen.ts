...
export const PRIVATE_CALL_STACK_ITEM_LENGTH = 238;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 235;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 222;
