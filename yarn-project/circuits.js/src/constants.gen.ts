...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 645;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 689;
export const PRIVATE_CALL_STACK_ITEM_LENGTH = 648;
...
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2483;
export const PUBLIC_ACCUMULATED_DATA_LENGTH = 1215;
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 4011;
export const KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 415;
