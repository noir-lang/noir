...
export const MAX_PUBLIC_DATA_UPDATE_REQUESTS_PER_TX = 31;
export const PROTOCOL_PUBLIC_DATA_UPDATE_REQUESTS_PER_TX = 1;
export const MAX_TOTAL_PUBLIC_DATA_UPDATE_REQUESTS_PER_TX = 32;
...
export const GAS_TOKEN_ADDRESS = 0x03d751d1a8655b35b0d0c8d74e35219104fe0b011bd262ee26e6c6a5c557c801n;
...
export const SCOPED_L2_TO_L1_MESSAGE_LENGTH = L2_TO_L1_MESSAGE_LENGTH + 1;
export const MAX_BLOCK_NUMBER_LENGTH = 2;
export const KEY_VALIDATION_REQUEST_LENGTH = 3;
export const KEY_VALIDATION_REQUEST_AND_GENERATOR_LENGTH = KEY_VALIDATION_REQUEST_LENGTH + 1;
export const SCOPED_KEY_VALIDATION_REQUEST_AND_GENERATOR_LENGTH = KEY_VALIDATION_REQUEST_AND_GENERATOR_LENGTH + 1;
export const PARTIAL_STATE_REFERENCE_LENGTH = 6;
export const READ_REQUEST_LENGTH = 2;
export const LOG_HASH_LENGTH = 3;
export const SCOPED_LOG_HASH_LENGTH = LOG_HASH_LENGTH + 1;
export const ENCRYPTED_LOG_HASH_LENGTH = 4;
export const SCOPED_ENCRYPTED_LOG_HASH_LENGTH = ENCRYPTED_LOG_HASH_LENGTH + 1;
export const NOTE_LOG_HASH_LENGTH = 4;
export const NOTE_HASH_LENGTH = 2;
export const SCOPED_NOTE_HASH_LENGTH = NOTE_HASH_LENGTH + 2;
export const NULLIFIER_LENGTH = 3;
export const SCOPED_NULLIFIER_LENGTH = NULLIFIER_LENGTH + 1;
...
export const COMBINED_ACCUMULATED_DATA_LENGTH =
  ...
  GAS_LENGTH;
export const COMBINED_CONSTANT_DATA_LENGTH = HEADER_LENGTH + TX_CONTEXT_LENGTH + GLOBAL_VARIABLES_LENGTH;
export const CALL_REQUEST_LENGTH = 1 + AZTEC_ADDRESS_LENGTH + CALLER_CONTEXT_LENGTH + 2;
...
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH =
  ...
  CALL_REQUEST_LENGTH +
  AZTEC_ADDRESS_LENGTH;
export const PUBLIC_ACCUMULATED_DATA_LENGTH =
  MAX_NEW_NOTE_HASHES_PER_TX * NOTE_HASH_LENGTH +
  MAX_NEW_NULLIFIERS_PER_TX * NULLIFIER_LENGTH +
  MAX_NEW_L2_TO_L1_MSGS_PER_TX * 1 +
  MAX_NOTE_ENCRYPTED_LOGS_PER_TX * LOG_HASH_LENGTH +
  MAX_ENCRYPTED_LOGS_PER_TX * LOG_HASH_LENGTH +
  MAX_UNENCRYPTED_LOGS_PER_TX * LOG_HASH_LENGTH +
  MAX_PUBLIC_DATA_UPDATE_REQUESTS_PER_TX * PUBLIC_DATA_UPDATE_REQUEST_LENGTH +
  MAX_PUBLIC_CALL_STACK_LENGTH_PER_TX * CALL_REQUEST_LENGTH +
  GAS_LENGTH;
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH =
  VALIDATION_REQUESTS_LENGTH +
...
export const ENQUEUE_PUBLIC_FUNCTION_CALL_RETURN_LENGTH = 3 + CALL_CONTEXT_LENGTH;
