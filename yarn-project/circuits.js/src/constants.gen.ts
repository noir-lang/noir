...
export const MAX_PACKED_PUBLIC_BYTECODE_SIZE_IN_FIELDS = 16000;
...
export const DEPLOYER_CONTRACT_ADDRESS = 0x2d8e7aedc70b65d49e6aa0794d8d12721896c177e87126701f6e60d184358e74n;
...
export const CALL_CONTEXT_LENGTH = 21;
export const GAS_SETTINGS_LENGTH = 10;
...
export const PRIVATE_CALL_STACK_ITEM_LENGTH = 224;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 221;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 215;
export const STATE_REFERENCE_LENGTH = 8;
export const TX_CONTEXT_DATA_LENGTH = 4;
export const TX_REQUEST_LENGTH = 18;
export const ENQUEUE_PUBLIC_FUNCTION_CALL_RETURN_LENGTH = 25;
