...
export const COMBINED_ACCUMULATED_DATA_LENGTH = 231;
export const COMBINED_CONSTANT_DATA_LENGTH = 40;
export const CALL_REQUEST_LENGTH = 7;
export const PRIVATE_ACCUMULATED_DATA_LENGTH = 1128;
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2715;
export const PUBLIC_ACCUMULATED_DATA_LENGTH = 881;
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 3566;
export const KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 281;
