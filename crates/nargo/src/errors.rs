...
pub enum CliError {
    ...
    #[error("Error: cannot find a build artifact for the circuit, expected an ACIR file at {}\nRun `nargo compile` to generate an ACIR file to use for proving", .0.display())]
    MissingAcir(PathBuf),
}
