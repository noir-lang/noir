...
use crate::ssa::ir::{
    dfg::DataFlowGraph,
    instruction::{Intrinsic, Instruction, Binary, BinaryOp},
    map::Id,
    types::Type,
    value::{Value, ValueId},
};
...
pub(super) fn simplify_call(
    ...
    match intrinsic {
        ...
        Intrinsic::SlicePushBack => {
            // The first argument is the size of the slice
            ...
            if let Some((mut slice, element_type)) = slice {
                ...
                // let new_slice_length = dfg.make_constant((slice.len() as u128).into(), Type::field());
