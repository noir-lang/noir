...
//!
//! Source file -[Lexing]-> Tokens -[Parsing]-> Ast -[Name Resolution]-> Hir -[Type Checking]-> Hir -[Monomorphisation]-> Monomorphised Ast
//!
//! After the monomorphised ast is created, it is passed to the noirc_evaluator crate to convert it to SSA form,
