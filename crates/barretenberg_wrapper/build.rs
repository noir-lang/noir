fn main() {
    ...
    println!(
        "cargo:rustc-link-search=../aztec2-internal/barretenberg/build/src/aztec/plonk/composer"
    );
    println!("cargo:rustc-link-lib=static=composer");
    println!(
        "cargo:rustc-link-search=../aztec2-internal/barretenberg/build/src/aztec/plonk/transcript"
    );
    println!("cargo:rustc-link-lib=static=transcript");
    println!(
        "cargo:rustc-link-search=../aztec2-internal/barretenberg/build/src/aztec/stdlib/primitives"
    );
    ...
    println!(
        "cargo:rustc-link-search=../aztec2-internal/barretenberg/build/src/aztec/crypto/keccak"
    );

    println!(
        "cargo:rustc-link-search=../aztec2-internal/barretenberg/build/src/aztec/crypto/pedersen"
    );
