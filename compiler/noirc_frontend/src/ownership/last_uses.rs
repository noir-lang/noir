...
impl LastUseContext {
    ...
    ///
    /// This is only called when the local variable was created in the current loop, so consider a
    /// loop body as a last use for something defined outside the loop.
