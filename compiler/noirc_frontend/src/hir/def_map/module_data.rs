...
use super::{ItemScope, LocalModuleId, ModuleDefId, ModuleId, PerNs, Visibility};
...
impl ModuleData {
    ...
    pub fn declare_trait_function(
        ...
        self.declare(name, Visibility::Private, id.into(), Some(trait_id))
    }
    ...
    pub fn declare_global(&mut self, name: Ident, id: GlobalId) -> Result<(), (Ident, Ident)> {
        self.declare(name, Visibility::Public, id.into(), None)
    }

    pub fn declare_struct(&mut self, name: Ident, id: StructId) -> Result<(), (Ident, Ident)> {
        self.declare(name, Visibility::Public, ModuleDefId::TypeId(id), None)
    }
    ...
    pub fn declare_trait(&mut self, name: Ident, id: TraitId) -> Result<(), (Ident, Ident)> {
        self.declare(name, Visibility::Public, ModuleDefId::TraitId(id), None)
    }
    ...
    pub fn declare_child_module(
        ...
        self.declare(name, Visibility::Public, child_id.into(), None)
    }
