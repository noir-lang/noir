...
pub enum DefCollectorErrorKind {
    ...
    #[error("Usage of the `#[foreign]` function attribute is not allowed outside of the Noir standard library")]
    ...
    fn from(error: DefCollectorErrorKind) -> Diagnostic {
        match error {
            ...
            DefCollectorErrorKind::LowLevelFunctionOutsideOfStdlib { span } => Diagnostic::simple_error(
                ...
                "Usage of the `#[foreign]` function attribute is not allowed outside of the Noir standard library".into(),
                span,
            ),
