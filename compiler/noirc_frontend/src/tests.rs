...
mod test {
    ...
    fn test_name_shadowing() {
        ...
        mod local_module {
            ...
            pub fn local_fn<A, N, B, M>(_x: (A, B), _y: [Field; N], _z: [Field; M]) -> [A; 0] {
        ...
        mod library {
            ...
            mod library2 {
                ...
                pub fn PubLiblocal_fn<A, N, B, M>(_x: (A, B), _y: [Field; N], _z: [Field; M]) -> [A; 0] {
            ...
            pub fn Liblocal_fn<A, N, B, M>(_x: (A, B), _y: [Field; N], _z: [Field; M]) -> [A; 0] {
        ...
        mod library3 {
            ...
            pub(crate) fn PubCrateLiblocal_fn<A, N, B, M>(_x: (A, B), _y: [Field; N], _z: [Field; M]) -> [A; 0] {
        ...
        use crate::library::library2::{PubLibLocalStruct, PubLibDefinedInLocalModule, PubLiblocal_fn, IMPORT_GLOBAL_N_2, IMPORT_GLOBAL_M_2};
        ...
        fn main(_x: ReExportMeFromAnotherLib, _y: ReExportMeFromAnotherLib2) {
            ...
            assert(drop_var(x.lib_trait_fn5([0; IMPORT_GLOBAL_N], [false; IMPORT_GLOBAL_M]), true));
            assert(drop_var(x.lib_trait_fn6([0; IMPORT_GLOBAL_N], [false; IMPORT_GLOBAL_M]), true));
            ...
            assert(drop_var(local_fn((0, 1), [], []), true));
            assert(drop_var(Liblocal_fn((0, 1), [], []), true));
            assert(drop_var(PubLiblocal_fn((0, 1), [], []), true));
            assert(drop_var(PubCrateLiblocal_fn((0, 1), [], []), true));
        }";
