...
mod tests {
    ...
    fn test_eat_integer_literals() {
        let test_cases: Vec<(&str, Token)> = vec![
            ("0x05", Token::Int(5_u128.into(), None)),
            ("5", Token::Int(5_u128.into(), None)),
    ...
    fn test_span() {
        ...
        let int_token = Token::Int(5_u128.into(), None).into_single_span(int_position);
