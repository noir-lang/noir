...
impl Elaborator<'_> {
    ...
    fn elaborate_constructor_with_type(
        ...
        // The struct's fields may still be deferred (e.g. resolving them
        // would have required a type generated by an attribute macro). Pull
        // them in now via the lazy path before reading.
