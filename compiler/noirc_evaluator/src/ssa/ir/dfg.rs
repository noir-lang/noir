...
impl DataFlowGraph {
    ...
    ///
    /// A numeric constant yields the exact width it requires; otherwise this runs the range analysis
    /// and returns the tightest width its inferred bounds allow, bounded by the value's type width.
