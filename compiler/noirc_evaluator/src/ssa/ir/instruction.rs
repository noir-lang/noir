...
/// The instructions that the IR is able to specify are vectored below.
pub enum Instruction {
    ...
    /// Performs a function call with a vector of its arguments.
...
/// will not be in the vector of instructions for a basic block.
#[derive(Debug, PartialEq, Eq, Hash, Clone, Serialize, Deserialize)]
