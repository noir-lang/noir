...
fn from_u32_list(list: &[u32], typ: NumericType) -> Value {
    let values = list.iter().map(|v| from_constant(u128::from(*v).into(), typ)).collect();
...
fn value_snapshot_detaches_from_original() {
    ...
    where
        F: FnOnce(&mut bool),
    {
        let Value::ArrayOrList(ArrayValue { elements, .. }) = value else {
...
#[test]
fn literally_just_the_lists_integration_test() {
    let src = r#"
acir(inline) fn main f0 {
  b0(v0: Field, v1: Field):
    ...
    v32 = load v5 -> u32
    v33 = load v7 -> [Field]
    v35, v36 = call list_push_back(v32, v33, v1) -> (u32, [Field])
    v37 = lt u32 2, v35
  ...
  b2():
    v167 = load v49 -> u32
    v168 = load v50 -> [u32]
    v169, v170 = call list_push_back(v167, v168, v2) -> (u32, [u32])
    store v169 at v49
    store v170 at v50
  ...
  b3():
    ...
    v56 = load v49 -> u32
    v57 = load v50 -> [u32]
    v60, v61 = call list_push_front(v56, v57, u32 20) -> (u32, [u32])
    store v60 at v49
    store v61 at v50
    v62 = load v49 -> u32
    v63 = load v50 -> [u32]
    ...
    v71 = load v49 -> u32
    v72 = load v50 -> [u32]
    v74, v75, v76 = call list_pop_back(v71, v72) -> (u32, [u32], u32)
    v78 = eq v76, u32 4
    constrain v76 == u32 4
    v79 = eq v74, u32 5
    constrain v74 == u32 5
    v81, v82, v83 = call list_pop_front(v74, v75) -> (u32, u32, [u32])
    v84 = eq v81, u32 20
    ...
    v91, v92 = call list_insert(v82, v83, u32 2, u32 100) -> (u32, [u32])
    store v91 at v49
    store v92 at v50
    v93 = load v49 -> u32
    v94 = load v50 -> [u32]
    ...
    v110, v111, v112 = call list_remove(v106, v107, u32 3) -> (u32, [u32], u32)
    v113 = eq v112, u32 2
...
acir(inline) fn append f1 {
  ...
  b2():
    ...
    v14 = load v5 -> u32
    v15 = load v6 -> [Field]
    v17, v18 = call list_push_back(v14, v15, v13) -> (u32, [Field])
    store v17 at v5
    store v18 at v6
...
acir(inline) fn map f2 {
  ...
  b2():
    ...
    v18, v19 = call list_push_back(v14, v15, v16) -> (u32, [Field])
    store v18 at v5
    store v19 at v7
...
acir(inline) fn regression_merge_lists f14 {
  b0(v0: Field, v1: Field):
    call f22(v0, v1)
    call f23(v0)
    return
...
acir(inline) fn regression_list_call_result f17 {
  b0(v0: Field, v1: Field):
  ...
  b1():
    v16 = load v5 -> u32
    v17 = load v6 -> [Field]
    v18, v19 = call list_push_back(v16, v17, Field 5) -> (u32, [Field])
    store v18 at v5
    store v19 at v6
    v20 = load v5 -> u32
    v21 = load v6 -> [Field]
    v23, v24 = call list_push_back(v20, v21, Field 10) -> (u32, [Field])
    store v23 at v5
    store v24 at v6
    jmp b3()
  b2():
    v10 = load v5 -> u32
    v11 = load v6 -> [Field]
    v14, v15 = call list_push_back(v10, v11, Field 5) -> (u32, [Field])
    store v14 at v5
    store v15 at v6
    jmp b3()
  b3():
...
acir(inline) fn merge_lists_return f19 {
  b0(v0: Field, v1: Field):
...
acir(inline) fn merge_lists_if f22 {
  b0(v0: Field, v1: Field):
    v3, v4 = call f19(v0, v1) -> (u32, [Field])
    v6 = eq v3, u32 3
    constrain v3 == u32 3
...
acir(inline) fn merge_lists_else f23 {
  b0(v0: Field):
...
acir(inline) fn merge_lists_mutate f24 {
  b0(v0: Field, v1: Field):
  ...
  b1():
    v14 = load v4 -> u32
    v15 = load v6 -> [Field]
    v16, v17 = call list_push_back(v14, v15, v1) -> (u32, [Field])
    store v16 at v4
    store v17 at v6
    v18 = load v4 -> u32
    v19 = load v6 -> [Field]
    v20, v21 = call list_push_back(v18, v19, v0) -> (u32, [Field])
    store v20 at v4
    store v21 at v6
    jmp b3()
  b2():
    v9 = load v4 -> u32
    v10 = load v6 -> [Field]
    v12, v13 = call list_push_back(v9, v10, v0) -> (u32, [Field])
    store v12 at v4
    store v13 at v6
    jmp b3()
  b3():
...
acir(inline) fn merge_lists_mutate_in_loop f25 {
  b0(v0: Field, v1: Field):
    v4 = make_array [Field 0, Field 0] : [Field]
    v5 = allocate -> &mut u32
    store u32 2 at v5
  ...
  b2():
    v10 = load v5 -> u32
    v11 = load v7 -> [Field]
    v13, v14 = call list_push_back(v10, v11, v0) -> (u32, [Field])
    store v13 at v5
    store v14 at v7
    jmp b6()
  b3(v2: u32):
  ...
  b4():
    ...
    v23, v24 = call list_push_back(v20, v21, v22) -> (u32, [Field])
    store v23 at v5
    store v24 at v7
...
acir(inline) fn merge_lists_mutate_two_ifs f26 {
  b0(v0: Field, v1: Field):
    v3 = make_array [Field 0, Field 0] : [Field]
    v4 = allocate -> &mut u32
    store u32 2 at v4
  ...
  b4():
    v24 = load v4 -> u32
    v25 = load v6 -> [Field]
    v26, v27 = call list_push_back(v24, v25, Field 20) -> (u32, [Field])
    store v26 at v4
    store v27 at v6
    jmp b5()
  b5():
    v28 = load v4 -> u32
    v29 = load v6 -> [Field]
    v31, v32 = call list_push_back(v28, v29, Field 15) -> (u32, [Field])
    store v31 at v4
    store v32 at v6
    v33 = load v4 -> u32
    v34 = load v6 -> [Field]
    v36, v37 = call list_push_back(v33, v34, Field 30) -> (u32, [Field])
    store v36 at v4
    store v37 at v6
    v38 = load v4 -> u32
    v39 = load v6 -> [Field]
...
acir(inline) fn merge_lists_mutate_between_ifs f27 {
  b0(v0: Field, v1: Field):
    v3 = make_array [Field 0, Field 0] : [Field]
    v4 = allocate -> &mut u32
    store u32 2 at v4
  ...
  b3():
    v22 = load v4 -> u32
    v23 = load v6 -> [Field]
    v25, v26 = call list_push_back(v22, v23, Field 30) -> (u32, [Field])
    store v25 at v4
    store v26 at v6
    v28 = eq v0, Field 20
  ...
  b4():
    v29 = load v4 -> u32
    v30 = load v6 -> [Field]
    v31, v32 = call list_push_back(v29, v30, Field 20) -> (u32, [Field])
    store v31 at v4
    store v32 at v6
    jmp b5()
  b5():
    v33 = load v4 -> u32
    v34 = load v6 -> [Field]
    v36, v37 = call list_push_back(v33, v34, Field 15) -> (u32, [Field])
    store v36 at v4
    store v37 at v6
    v38 = eq v0, Field 20
    v39 = not v38
  ...
  b6():
    v40 = load v4 -> u32
    v41 = load v6 -> [Field]
    v43, v44 = call list_push_back(v40, v41, Field 50) -> (u32, [Field])
    store v43 at v4
    store v44 at v6
    jmp b7()
  b7():
    v45 = load v4 -> u32
    v46 = load v6 -> [Field]
    v48, v49 = call list_push_back(v45, v46, Field 60) -> (u32, [Field])
    store v48 at v4
    store v49 at v6
    v50 = load v4 -> u32
    v51 = load v6 -> [Field]
...
acir(inline) fn merge_lists_push_then_pop f28 {
  b0(v0: Field, v1: Field):
    v3 = make_array [Field 0, Field 0] : [Field]
    v4 = allocate -> &mut u32
    store u32 2 at v4
  ...
  b5():
    v33 = load v4 -> u32
    v34 = load v6 -> [Field]
    v36, v37, v38 = call list_pop_back(v33, v34) -> (u32, [Field], Field)
    v40 = eq v36, u32 4
    constrain v36 == u32 4
    v41 = eq v38, Field 30
    constrain v38 == Field 30
    v42, v43, v44 = call list_pop_back(v36, v37) -> (u32, [Field], Field)
    v46 = eq v42, u32 3
    constrain v42 == u32 3
    v47 = eq v44, v0
    constrain v44 == v0
...
acir(inline) fn merge_lists_push_then_insert f29 {
  b0(v0: Field, v1: Field):
    v3 = make_array [Field 0, Field 0] : [Field]
    v4 = allocate -> &mut u32
    store u32 2 at v4
  ...
  b5():
    ...
    v46, v47 = call list_insert(v38, v39, u32 1, Field 50) -> (u32, [Field])
    store v46 at v4
    store v47 at v6
    v48 = load v4 -> u32
    v49 = load v6 -> [Field]
    ...
    v54, v55 = call list_insert(v48, v49, u32 6, Field 100) -> (u32, [Field])
    store v54 at v4
    store v55 at v6
    v56 = load v4 -> u32
    v57 = load v6 -> [Field]
...
acir(inline) fn merge_lists_remove_between_ifs f30 {
  b0(v0: Field, v1: Field):
    v3 = make_array [Field 0, Field 0] : [Field]
    v4 = allocate -> &mut u32
    store u32 2 at v4
  ...
  b3():
    ...
    v27, v28, v29 = call list_remove(v22, v23, u32 2) -> (u32, [Field], Field)
  ...
  b4():
    v35 = load v30 -> u32
    v36 = load v31 -> [Field]
    v37, v38 = call list_push_back(v35, v36, Field 20) -> (u32, [Field])
    store v37 at v30
    store v38 at v31
    jmp b5()
  b5():
    v39 = load v30 -> u32
    v40 = load v31 -> [Field]
    v42, v43 = call list_push_back(v39, v40, Field 15) -> (u32, [Field])
    store v42 at v30
    store v43 at v31
    v44 = eq v0, Field 20
    v45 = not v44
  ...
  b6():
    v46 = load v30 -> u32
    v47 = load v31 -> [Field]
    v49, v50 = call list_push_back(v46, v47, Field 50) -> (u32, [Field])
    store v49 at v30
    store v50 at v31
    jmp b7()
  b7():
