...
mod test {
    ...
    #[test]
    fn correctly_handles_a_negated_jmpif() {
        // This program is a regression test for the below program
        //
        // ```noir
        // fn main(x: bool) {
        //     let mut q = 0;
        ...
        acir(inline) fn main f0 {
          b0(v0: u1):
            v1 = allocate -> &mut Field
            store Field 0 at v1 // let q = 0
            enable_side_effects v0
            v3 = load v1 -> Field // 0
            v4 = cast v0 as Field // x
            v6 = sub Field 2, v3 // 2 - 0
            v7 = mul v4, v6 // 2 * x
            v8 = add v3, v7 // 0 + 2 * x
            store v8 at v1 // q = 2 * x <- THIS IS VERY WRONG. This should be q = 2 * !x.
            v9 = not v0
            enable_side_effects u1 1
            v11 = load v1 -> Field
