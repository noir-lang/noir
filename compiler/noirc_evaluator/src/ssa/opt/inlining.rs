...
impl<'function> PerFunctionContext<'function> {
    ...
    fn translate_value(&mut self, id: ValueId<FieldElement>) -> ValueId<FieldElement> {
    ...
    fn get_function(&mut self, mut id: ValueId<FieldElement>) -> Option<FunctionId> {
    ...
    fn inline_blocks(&mut self, ssa: &Ssa) -> Vec<ValueId<FieldElement>> {
    ...
    fn handle_function_returns(
        &mut self,
        mut returns: Vec<(BasicBlockId, Vec<ValueId<FieldElement>>)>,
    ) -> Vec<ValueId<FieldElement>> {
    ...
    fn inline_function(
        &mut self,
        ssa: &Ssa,
        call_id: InstructionId<FieldElement>,
        function: FunctionId,
        arguments: &[ValueId<FieldElement>],
    ) {
    ...
    fn push_instruction(&mut self, id: InstructionId<FieldElement>) {
    ...
    fn handle_terminator_instruction(
        ...
        block_queue: &mut Vec<BasicBlockId>,
    ) -> Option<(BasicBlockId, Vec<ValueId<FieldElement>>)> {
