...
impl ConstantAllocation {
    ...
    pub(crate) fn allocated_in_block(&self, block_id: BasicBlockId) -> Vec<FinalValueId> {
...
pub(crate) fn is_constant_value(id: FinalValueId, dfg: &DataFlowGraph) -> bool {
