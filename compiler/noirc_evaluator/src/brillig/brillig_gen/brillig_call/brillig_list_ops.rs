//! Codegen for converting SSA list intrinsic functions to Brillig bytecode.
...
impl<Registers: RegisterAllocator> BrilligBlock<'_, Registers> {
    ...
    pub(crate) fn list_push_back_operation(
        &mut self,
    ...
    /// then write those variables to the returned write pointer.
    pub(crate) fn list_push_front_operation(
        &mut self,
        target_vector: BrilligVector,
        source_len: SingleAddrVariable,
        source_vector: BrilligVector,
    ...
    pub(crate) fn list_pop_front_operation(
        &mut self,
        target_vector: BrilligVector,
        source_len: SingleAddrVariable,
        source_vector: BrilligVector,
    ...
    pub(crate) fn list_pop_back_operation(
        &mut self,
        target_vector: BrilligVector,
        source_len: SingleAddrVariable,
        source_vector: BrilligVector,
    ...
    pub(crate) fn list_insert_operation(
        &mut self,
        target_vector: BrilligVector,
        source_vector: BrilligVector,
    ...
    pub(crate) fn list_remove_operation(
        &mut self,
        target_vector: BrilligVector,
        source_vector: BrilligVector,
        index: SingleAddrVariable,
    ...
    fn test_list_push_operation() {
        fn test_case_push(
            ...
            let arguments = vec![
                ...
                // The input list of the array items, with a known size/capacity.
            ...
            // Entry points don't support returning lists, so we implicitly cast the vector to an array
            ...
            if push_back {
                block.list_push_back_operation(
                    *target_vector,
                    *source_len_var,
                    *source_vector,
                ...
                block.list_push_front_operation(
                    *target_vector,
                    *source_len_var,
                    *source_vector,
                    &[item_to_insert.to_var()],
    ...
    fn test_list_pop_operation() {
        fn test_case_pop(
            ...
            if pop_back {
                ...
                block.list_pop_front_operation(
                    *target_vector,
                    *source_len_var,
                    *source_vector,
                    &[removed_item.to_var()],
