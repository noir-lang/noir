...
impl<'block, Registers: RegisterAllocator> BrilligBlock<'block, Registers> {
    ...
    fn convert_ssa_terminator(
        ...
        match terminator_instruction {
            TerminatorInstruction::JmpIf {
                ...
                self.conditionally_move_jmpif_then_arguments(
                    dfg,
                    condition,
                    *then_destination,
                    then_arguments,
    ...
    /// Conditionally move only the `then_arguments` of a jmpif terminator.
    ///
    ...
    fn conditionally_move_jmpif_then_arguments(
        &mut self,
        dfg: &DataFlowGraph,
