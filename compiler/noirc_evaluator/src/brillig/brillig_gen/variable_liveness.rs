...
mod tests {
    ...
    fn test_last_use_deallocation() {
        ...
        fn main
         ...
         7: sp[3] = field add sp[4], sp[2]
         8: sp[2] = const field 3
         9: sp[4] = field add sp[3], sp[2]
        10: sp[2] = sp[4]
        11: return
        ");
    }
    ...
    fn test_loop_liveness() {
        ...
        fn main
         ...
         6: sp[3] = sp[4]
         7: jump to 0
         8: sp[4] = u32 lt sp[3], sp[2]
         9: jump if sp[4] to 0
        10: jump to 0
        11: sp[2] = sp[3]
        12: return
        13: sp[4] = u32 add sp[3], sp[5]
        14: sp[6] = u32 lt_eq sp[3], sp[4]
        15: jump if sp[6] to 0
        16: call 0
        17: sp[3] = sp[4]
        18: jump to 0
        ");
    ...
    fn test_block_parameters() {
        ...
        fn main
         ...
         7: sp[3] = sp[4]
         8: jump to 0
         9: sp[2] = const field 27
        10: sp[5] = field add sp[2], sp[4]
        11: sp[3] = sp[5]
        12: jump to 0
        13: sp[2] = sp[3]
        14: return
    ...
    fn test_constants_liveness() {
        ...
        fn main
         ...
         7: sp[5] = field mul sp[2], sp[3]
         8: sp[2] = field add sp[4], sp[5]
         9: return
        ");
    }
    ...
    fn test_terminator_arguments_stay_alive() {
        ...
        fn main
         ...
         6: sp[2] = const field 2
         7: sp[4] = field add sp[5], sp[2]
         8: sp[2] = const field 3
         9: sp[5] = field mul sp[4], sp[2]
        10: sp[3] = sp[5]
        11: jump to 0
        12: sp[2] = sp[3]
        13: return
