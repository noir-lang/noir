...
impl CheckContext {
    pub fn new<R: RegisterAllocator>(registers: &R) -> Self {
        Self {
    ...
    pub fn visit_opcode<F>(&mut self, opcode: &Opcode<F>, location: OpcodeLocation) {
        match opcode {
    ...
    pub fn into_advisories(self) -> HashMap<OpcodeLocation, OpcodeAdvisory> {
        self.advisories
    }
