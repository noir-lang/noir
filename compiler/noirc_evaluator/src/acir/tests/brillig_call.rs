...
fn multiple_brillig_calls_one_bytecode() {
    ...
    10: call 16
    11: @72 = sp[1]
    12: sp[2] = const u32 72
    13: sp[3] = const u32 1
    14: stop @[sp[2]; sp[3]]
    15: return
    16: call 24
    17: sp[3] = field eq sp[1], sp[2]
    18: sp[2] = const bool 0
    19: sp[4] = bool eq sp[3], sp[2]
    20: jump if sp[4] to 23
    21: sp[5] = const u32 0
    22: trap @[@1; sp[5]]
    23: return
    24: @6 = const u32 30793
    25: @5 = u32 lt @0, @6
    26: jump if @5 to 29
...
fn brillig_stdlib_calls_with_regular_brillig_call() {
    ...
    17: return
    18: call 26
    19: sp[3] = u32 eq sp[1], sp[2]
    20: sp[2] = const bool 0
    21: sp[4] = bool eq sp[3], sp[2]
    22: jump if sp[4] to 25
    23: sp[5] = const u32 0
    24: trap @[@1; sp[5]]
    25: return
    26: @6 = const u32 30793
    27: @5 = u32 lt @0, @6
    28: jump if @5 to 31
