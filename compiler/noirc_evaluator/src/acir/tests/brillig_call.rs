...
fn multiple_brillig_stdlib_calls() {
    ...
    BLACKBOX::RANGE inputs: [w9], bits: 32, outputs: []
    EXPR w10 = w2 - w9 - 1
    BLACKBOX::RANGE inputs: [w10], bits: 32, outputs: []
    EXPR w9 = -w2*w8 + w1
    EXPR w8 = 1
