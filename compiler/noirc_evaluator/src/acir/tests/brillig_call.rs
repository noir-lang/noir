...
fn multiple_brillig_calls_one_bytecode() {
    ...
    14: return
    15: call 23
    16: sp[4] = field eq sp[2], sp[3]
    17: sp[3] = const bool 0
    18: sp[5] = bool eq sp[4], sp[3]
    19: jump if sp[5] to 22
    20: sp[6] = const u32 0
    21: trap @[@1; sp[6]]
    22: return
...
fn brillig_stdlib_calls_with_regular_brillig_call() {
    ...
    16: return
    17: call 25
    18: sp[4] = u32 eq sp[2], sp[3]
    19: sp[3] = const bool 0
    20: sp[5] = bool eq sp[4], sp[3]
    21: jump if sp[5] to 24
    22: sp[6] = const u32 0
    23: trap @[@1; sp[6]]
    24: return
