...
fn slice_insert() {
    ...
    BRILLIG CALL func: 0, inputs: [w1 + 18446744073709551616, 18446744073709551616], outputs: [w9, w10]
    BLACKBOX::RANGE input: w9, bits: 1
    BLACKBOX::RANGE input: w10, bits: 64
    ASSERT w10 = w1 - 18446744073709551616*w9 + 18446744073709551616
    READ w11 = b1[w6]
    ASSERT w12 = -w7*w9 + 1
    ASSERT w13 = 10*w7*w9 + w11*w12
    WRITE b2[w6] = w13
    ...
    BRILLIG CALL func: 0, inputs: [w1 + 18446744073709551615, 18446744073709551616], outputs: [w16, w17]
    BLACKBOX::RANGE input: w16, bits: 1
    BLACKBOX::RANGE input: w17, bits: 64
    ASSERT w17 = w1 - 18446744073709551616*w16 + 18446744073709551615
    ASSERT w18 = -w14 + 1
    READ w19 = b1[w18]
    ASSERT w20 = -w14*w16 + 1
    ASSERT w21 = 1
    ASSERT w22 = 10*w14*w16 + w19*w20
    WRITE b2[w21] = w22
    ...
    BRILLIG CALL func: 0, inputs: [w1 + 18446744073709551614, 18446744073709551616], outputs: [w25, w26]
    BLACKBOX::RANGE input: w25, bits: 1
    BLACKBOX::RANGE input: w26, bits: 64
    ASSERT w26 = w1 - 18446744073709551616*w25 + 18446744073709551614
    ASSERT w27 = -w23 + 2
    READ w28 = b1[w27]
    ASSERT w29 = -w23*w25 + 1
    ASSERT w30 = 10*w23*w25 + w28*w29
    WRITE b2[w2] = w30
    ...
    BRILLIG CALL func: 0, inputs: [w1 + 18446744073709551613, 18446744073709551616], outputs: [w33, w34]
    BLACKBOX::RANGE input: w33, bits: 1
    BLACKBOX::RANGE input: w34, bits: 64
    ASSERT w34 = w1 - 18446744073709551616*w33 + 18446744073709551613
    ASSERT w35 = -w31 + 3
    READ w36 = b1[w35]
    ASSERT w37 = -w31*w33 + 1
    ASSERT w38 = 10*w31*w33 + w36*w37
    WRITE b2[w3] = w38
    ASSERT w1 = 4
    ASSERT w39 = 20
    WRITE b2[w0] = w39
