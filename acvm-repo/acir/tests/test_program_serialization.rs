...
fn multi_scalar_mul_circuit() {
    ...
    let expected_serialization: Vec<u8> = vec![
        31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 93, 141, 11, 10, 0, 32, 8, 67, 87, 246, 189, 255, 133,
        91, 52, 97, 36, 60, 230, 111, 90, 240, 98, 147, 162, 252, 234, 34, 97, 117, 82, 165, 161,
        60, 231, 77, 218, 201, 32, 83, 55, 160, 30, 204, 31, 218, 207, 62, 236, 215, 239, 245, 56,
        194, 131, 194, 221, 172, 0, 0, 0,
    ];
...
fn memory_op_circuit() {
    ...
    let expected_serialization: Vec<u8> = vec![
        ...
        147, 140, 24, 118, 231, 169, 97, 212, 55, 245, 106, 95, 76, 246, 229, 60, 47, 45, 238, 86,
        127, 235, 86, 146, 127, 231, 144, 147, 194, 29, 179, 11, 220, 154, 50, 208, 200, 5, 36, 3,
        0, 0,
    ];
