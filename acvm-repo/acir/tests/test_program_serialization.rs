...
fn memory_op_circuit() {
    ...
    let bytes_msgpack =
        Program::serialize_program_with_format(&program, SerializationFormat::Msgpack);
    insta::assert_compact_debug_snapshot!(bytes_msgpack, @"[31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 125, 144, 205, 78, 66, 65, 12, 133, 225, 130, 15, 231, 194, 248, 8, 147, 97, 166, 154, 198, 123, 59, 147, 182, 131, 178, 4, 22, 110, 47, 242, 2, 198, 128, 34, 9, 49, 154, 24, 246, 240, 98, 76, 184, 225, 111, 195, 170, 237, 201, 215, 166, 231, 20, 163, 239, 135, 68, 78, 49, 144, 76, 94, 87, 135, 222, 144, 173, 224, 253, 223, 37, 102, 32, 53, 207, 168, 4, 34, 6, 201, 195, 75, 235, 43, 68, 23, 60, 200, 116, 184, 188, 131, 42, 240, 224, 150, 80, 199, 139, 94, 25, 220, 147, 65, 223, 154, 97, 158, 223, 218, 197, 178, 81, 116, 16, 225, 179, 1, 135, 139, 166, 222, 199, 209, 9, 255, 8, 113, 60, 99, 176, 126, 59, 223, 223, 191, 153, 247, 109, 153, 160, 115, 29, 222, 92, 192, 221, 191, 200, 216, 183, 10, 38, 90, 206, 175, 43, 176, 76, 219, 69, 231, 55, 166, 94, 137, 238, 76, 173, 87, 12, 154, 152, 204, 126, 79, 38, 221, 31, 43, 2, 172, 166, 202, 6, 237, 35, 72, 189, 206, 25, 228, 52, 148, 45, 18, 120, 115, 140, 167, 222, 1, 194, 117, 186, 149, 44, 1, 0, 0]");

    let bytes_default = Program::serialize_program(&program);
    insta::assert_compact_debug_snapshot!(bytes_default, @"[31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 85, 199, 171, 13, 192, 32, 16, 0, 208, 131, 131, 225, 42, 154, 78, 81, 81, 209, 79, 154, 154, 74, 54, 56, 238, 4, 22, 69, 8, 99, 192, 98, 8, 20, 234, 229, 33, 251, 16, 65, 92, 89, 247, 243, 126, 255, 229, 58, 62, 1, 86, 58, 141, 187, 60, 220, 30, 6, 105, 22, 167, 87, 107, 68, 105, 36, 111, 136, 58, 150, 210, 125, 19, 72, 0, 0, 0]");
