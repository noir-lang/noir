...
fn multi_scalar_mul_circuit() {
    ...
    let bytes_msgpack =
        Program::serialize_program_with_format(&program, SerializationFormat::Msgpack);
    insta::assert_compact_debug_snapshot!(bytes_msgpack, @"[31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 77, 143, 189, 170, 2, 49, 16, 133, 113, 175, 127, 247, 181, 188, 112, 59, 43, 11, 203, 48, 102, 71, 9, 198, 36, 204, 76, 196, 118, 69, 172, 87, 5, 107, 43, 23, 11, 127, 27, 95, 207, 32, 184, 216, 125, 204, 57, 28, 230, 203, 150, 167, 113, 116, 90, 140, 119, 188, 89, 159, 63, 172, 28, 204, 240, 80, 249, 160, 125, 142, 188, 41, 110, 61, 11, 122, 218, 243, 139, 255, 84, 248, 3, 107, 139, 75, 63, 90, 49, 3, 13, 22, 40, 225, 234, 24, 188, 113, 194, 219, 162, 26, 26, 113, 200, 220, 168, 41, 171, 248, 93, 251, 10, 155, 53, 181, 78, 129, 48, 55, 26, 4, 235, 91, 187, 242, 81, 66, 76, 107, 157, 238, 35, 144, 153, 167, 80, 5, 160, 244, 147, 32, 241, 190, 145, 253, 52, 91, 237, 123, 136, 35, 107, 244, 87, 80, 158, 9, 37, 146, 83, 115, 176, 17, 121, 215, 233, 254, 94, 129, 25, 73, 212, 44, 205, 194, 4, 185, 124, 38, 129, 228, 42, 4, 198, 97, 174, 106, 249, 242, 5, 164, 248, 75, 255, 10, 1, 0, 0]");

    let bytes_default = Program::serialize_program(&program);
    insta::assert_compact_debug_snapshot!(bytes_default, @"[31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 69, 200, 187, 10, 128, 32, 20, 0, 80, 122, 248, 232, 183, 12, 218, 154, 26, 154, 69, 26, 164, 139, 65, 42, 180, 250, 7, 106, 225, 220, 214, 22, 125, 98, 77, 182, 29, 78, 21, 67, 58, 131, 123, 24, 112, 49, 179, 101, 235, 172, 18, 45, 7, 112, 119, 111, 193, 200, 65, 112, 224, 235, 199, 35, 186, 107, 148, 70, 77, 90, 23, 89, 229, 159, 117, 22, 202, 194, 145, 208, 84, 148, 85, 141, 176, 223, 9, 109, 188, 127, 1, 1, 101, 19, 241, 110, 0, 0, 0]");
