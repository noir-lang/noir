...
fn memory_op_circuit() {
    ...
    ";
    let mut circuit = Circuit::from_str(src).unwrap();
    circuit.current_witness_index = 6;

    let program = Program { functions: vec![circuit], unconstrained_functions: vec![] };

    let bytes_msgpack =
        Program::serialize_program_with_format(&program, SerializationFormat::Msgpack);
    insta::assert_compact_debug_snapshot!(bytes_msgpack, @"[31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 213, 147, 75, 78, 195, 48, 16, 134, 211, 180, 112, 14, 174, 195, 2, 113, 132, 145, 227, 12, 200, 34, 126, 48, 99, 23, 186, 108, 179, 96, 155, 180, 23, 64, 64, 161, 169, 84, 33, 64, 136, 11, 112, 48, 76, 34, 30, 43, 154, 5, 66, 194, 27, 219, 51, 163, 249, 126, 141, 230, 79, 103, 205, 81, 48, 210, 43, 107, 184, 190, 216, 124, 188, 193, 8, 141, 151, 207, 50, 16, 161, 241, 112, 166, 188, 65, 102, 80, 38, 199, 243, 221, 59, 235, 164, 205, 145, 23, 211, 245, 1, 106, 75, 147, 125, 163, 124, 185, 202, 10, 43, 79, 64, 229, 201, 141, 138, 255, 249, 32, 93, 119, 17, 63, 113, 120, 219, 21, 78, 87, 221, 125, 232, 102, 95, 229, 87, 214, 149, 141, 117, 72, 226, 157, 92, 54, 58, 20, 224, 145, 52, 87, 79, 133, 50, 40, 8, 164, 213, 153, 50, 109, 154, 171, 235, 83, 144, 175, 123, 201, 207, 103, 176, 108, 165, 110, 107, 86, 207, 183, 119, 218, 233, 5, 76, 150, 99, 81, 4, 252, 13, 224, 176, 31, 240, 207, 102, 153, 252, 227, 89, 142, 250, 1, 31, 29, 169, 177, 240, 8, 78, 80, 92, 252, 200, 228, 197, 32, 29, 62, 184, 144, 21, 74, 126, 139, 86, 27, 66, 31, 200, 64, 171, 144, 235, 209, 189, 96, 70, 242, 160, 163, 61, 196, 49, 114, 245, 18, 29, 20, 197, 121, 18, 81, 113, 14, 159, 230, 170, 222, 0, 148, 199, 21, 237, 106, 3, 0, 0]");

    let bytes_default = Program::serialize_program(&program);
    insta::assert_compact_debug_snapshot!(bytes_default, @"[31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 189, 143, 169, 13, 128, 64, 20, 68, 255, 30, 80, 7, 237, 32, 8, 85, 32, 16, 28, 33, 24, 228, 118, 240, 15, 129, 69, 17, 66, 29, 20, 134, 88, 207, 95, 204, 142, 153, 76, 50, 121, 201, 115, 76, 251, 81, 74, 184, 155, 110, 152, 150, 173, 30, 251, 85, 128, 141, 61, 227, 14, 87, 236, 118, 102, 16, 65, 124, 42, 248, 142, 17, 36, 214, 95, 133, 122, 129, 52, 144, 211, 65, 191, 29, 32, 179, 131, 79, 0, 25, 235, 144, 60, 226, 11, 210, 26, 47, 140, 176, 1, 0, 0]");
