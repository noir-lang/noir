...
fn memory_op_circuit() {
    ...
    let bytes_default = Program::serialize_program(&program);
    insta::assert_compact_debug_snapshot!(bytes_default, @"[31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 173, 142, 59, 10, 128, 48, 16, 68, 119, 179, 57, 136, 215, 177, 16, 79, 97, 97, 225, 7, 177, 177, 204, 13, 246, 83, 216, 90, 137, 120, 14, 15, 102, 145, 222, 68, 200, 52, 195, 192, 131, 121, 164, 178, 31, 96, 225, 110, 186, 97, 90, 182, 122, 236, 87, 3, 69, 119, 198, 29, 174, 216, 237, 172, 96, 198, 252, 84, 240, 29, 204, 132, 68, 211, 20, 37, 17, 248, 237, 7, 5, 253, 124, 198, 27, 58, 98, 241, 204, 47, 203, 3, 217, 171, 104, 1, 0, 0]");
