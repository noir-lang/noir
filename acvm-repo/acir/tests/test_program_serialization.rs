...
fn multi_scalar_mul_circuit() {
    ...
    let expected_serialization: Vec<u8> = vec![
        31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 93, 141, 73, 14, 0, 32, 8, 3, 101, 115, 123, 181, 79,
        183, 198, 30, 80, 146, 73, 161, 164, 32, 229, 214, 0, 194, 254, 232, 4, 150, 230, 5, 148,
        106, 244, 148, 123, 167, 31, 212, 10, 26, 232, 220, 71, 186, 163, 204, 123, 242, 75, 250,
        245, 103, 159, 218, 94, 230, 176, 128, 173, 0, 0, 0,
    ];
