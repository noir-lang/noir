...
{
    {
        ...
        for (size_t i = beg; i < end; i++) {
            ...
            info("internal_call:      ", trace.at(i).main_sel_internal_call);
            info("internal_return:    ", trace.at(i).main_sel_internal_return);
            ...
            info("first:              ", trace.at(i).main_first);
            info("last:               ", trace.at(i).main_last);
