...
inline const uint32_t PCPI_NULLIFIER_EXISTS_OFFSET = PCPI_NOTE_HASH_EXISTS_OFFSET + MAX_NEW_NOTE_HASHES_PER_CALL;
...
inline const uint32_t PCPI_L1_TO_L2_MSG_READ_REQUESTS_OFFSET =
    PCPI_NULLIFIER_NON_EXISTS_OFFSET + MAX_NULLIFIER_NON_EXISTENT_READ_REQUESTS_PER_CALL;
inline const uint32_t PCPI_PUBLIC_DATA_UPDATE_OFFSET =
    PCPI_L1_TO_L2_MSG_READ_REQUESTS_OFFSET + MAX_NULLIFIER_NON_EXISTENT_READ_REQUESTS_PER_CALL * READ_REQUEST_LENGTH;
inline const uint32_t PCPI_PUBLIC_DATA_READ_OFFSET =
    PCPI_PUBLIC_DATA_UPDATE_OFFSET + MAX_PUBLIC_DATA_UPDATE_REQUESTS_PER_CALL * CONTRACT_STORAGE_UPDATE_REQUEST_LENGTH;
