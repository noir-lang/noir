...
template <typename FF_> class mainImpl {
  public:
    ...
    static constexpr std::array<size_t, 150> SUBRELATION_PARTIAL_LENGTHS = {
        3, 3, 4, 4, 3, 3, 4, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
        3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
        3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 5, 4, 4, 3, 3, 3, 3, 3, 3, 4, 3, 3,
        3, 3, 3, 3, 3, 3, 3, 3, 3, 5, 3, 3, 3, 4, 4, 3, 3, 3, 3, 3, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3,
        3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 2
    };
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        const auto main_INTERNAL_CALL_STACK_SELECTORS =
            (((new_term.main_sel_first + new_term.main_sel_op_internal_call) + new_term.main_sel_op_internal_return) +
        ...
        const auto main_SEL_ALL_MEMORY = (new_term.main_sel_op_cmov + new_term.main_sel_op_mov);
        const auto main_SEL_ALL_MEM_SLICE = (new_term.main_sel_op_calldata_copy + new_term.main_sel_op_external_return);
        const auto main_OPCODE_SELECTORS =
            ((((((((new_term.main_sel_op_fdiv + main_SEL_ALL_ALU) + main_SEL_ALL_BINARY) + main_SEL_ALL_MEMORY) +
                 main_SEL_ALL_GADGET) +
                main_KERNEL_INPUT_SELECTORS) +
               main_KERNEL_OUTPUT_SELECTORS) +
              main_SEL_ALL_LEFTGAS) +
             main_SEL_ALL_MEM_SLICE);
        ...
        }
        {
            ...
            auto tmp = ((new_term.main_sel_gas_accounting_active * (FF(1) - new_term.main_sel_op_external_call)) *
        ...
        }
        {
            ...
            auto tmp = ((FF(1) - new_term.main_sel_gas_accounting_active) * new_term.main_l2_gas_op_cost);
            tmp *= scaling_factor;
            std::get<4>(evals) += typename Accumulator::View(tmp);
        }
        {
            using Accumulator = typename std::tuple_element_t<5, ContainerOverSubrelations>;
            auto tmp = ((FF(1) - new_term.main_sel_gas_accounting_active) * new_term.main_da_gas_op_cost);
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_coinbase * (FF(1) - new_term.main_sel_op_coinbase));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_halt * (FF(1) - new_term.main_sel_op_halt));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp =
                ((((FF(1) - new_term.main_sel_first) * (FF(1) - new_term.main_sel_op_halt)) * main_OPCODE_SELECTORS) *
        ...
        }
        {
            ...
            auto tmp = ((FF(1) - main_INTERNAL_CALL_STACK_SELECTORS) *
        ...
        }
        {
            ...
            auto tmp = (main_OPCODE_SELECTORS * (new_term.main_call_ptr - new_term.main_space_id));
            tmp *= scaling_factor;
