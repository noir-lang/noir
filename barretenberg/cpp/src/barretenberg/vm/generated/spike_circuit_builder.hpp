...
class SpikeCircuitBuilder {
  public:
    ...
    [[maybe_unused]] bool check_circuit()
    {
        ...
        auto spike = [=]() {
            return evaluate_relation.template operator()<Spike_vm::spike<FF>>("spike",
                                                                              Spike_vm::get_relation_label_spike);
        };
        ...
        relation_futures.emplace_back(std::async(std::launch::async, spike));
