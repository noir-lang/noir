...
class range_check_da_gas_lo_lookup_settings {
  public:
    ...
    {
        return (in.avm_main_gas_cost_active == 1 || in.avm_main_sel_rng_16 == 1);
    }
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.range_check_da_gas_lo,
                                     in.range_check_da_gas_lo_counts,
                                     in.avm_main_gas_cost_active,
                                     in.avm_main_sel_rng_16,
                                     in.avm_main_abs_da_rem_gas_lo,
                                     in.avm_main_clk);
    }
...
using range_check_da_gas_lo_relation = GenericLookupRelation<range_check_da_gas_lo_lookup_settings, FF_>;
