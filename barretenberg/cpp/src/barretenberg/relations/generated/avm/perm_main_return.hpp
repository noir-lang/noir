...
class perm_main_return_permutation_settings {
  public:
    ...
    {
        return (in.main_sel_return_gadget == 1 || in.slice_sel_start_return == 1);
    }
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.perm_main_return,
                                     in.main_sel_return_gadget,
                                     in.main_sel_return_gadget,
                                     in.slice_sel_start_return,
                                     in.main_clk,
                                     in.main_space_id,
                                     in.main_ia,
                                     in.main_ib,
...
using perm_main_return_relation = GenericPermutationRelation<perm_main_return_permutation_settings, FF_>;
template <typename FF_> using perm_main_return = GenericPermutation<perm_main_return_permutation_settings, FF_>;
