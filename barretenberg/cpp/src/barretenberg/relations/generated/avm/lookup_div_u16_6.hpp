...
class lookup_div_u16_6_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.lookup_div_u16_6,
...
template <typename FF_> using lookup_div_u16_6_relation = GenericLookupRelation<lookup_div_u16_6_lookup_settings, FF_>;
