...
class lookup_u8_1_lookup_settings {
  public:
    ...
    {
        return (in.avm_alu_rng_chk_lookup_selector == 1 || in.avm_main_sel_rng_8 == 1);
    }
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.lookup_u8_1,
...
template <typename FF_> using lookup_u8_1_relation = GenericLookupRelation<lookup_u8_1_lookup_settings, FF_>;
