...
template <typename FF_> class avm_mainImpl {
  public:
    ...
    static constexpr std::array<size_t, 146> SUBRELATION_PARTIAL_LENGTHS{
        3, 3, 3, 3, 3, 3, 5, 5, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
        3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
        3, 5, 4, 4, 3, 3, 3, 3, 3, 3, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 5, 3, 3, 3, 4, 4, 3, 3, 3, 3, 3, 4, 3, 3,
        3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2,
    };
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        // Contribution 0
        {
            ...
            auto tmp = (avm_main_l2_out_of_gas * (-avm_main_l2_out_of_gas + FF(1)));
            tmp *= scaling_factor;
            std::get<0>(evals) += tmp;
        }
        // Contribution 1
        {
            ...
            auto tmp = (avm_main_da_out_of_gas * (-avm_main_da_out_of_gas + FF(1)));
            tmp *= scaling_factor;
            std::get<1>(evals) += tmp;
        }
        // Contribution 2
        ...
        // Contribution 6
        {
            ...
            auto tmp = (avm_main_gas_cost_active *
                        ((((-(avm_main_l2_out_of_gas * FF(2)) + FF(1)) * avm_main_l2_gas_remaining_shift) -
                          (avm_main_abs_l2_rem_gas_hi * FF(65536))) -
        ...
        // Contribution 7
        {
            ...
            auto tmp = (avm_main_gas_cost_active *
                        ((((-(avm_main_da_out_of_gas * FF(2)) + FF(1)) * avm_main_da_gas_remaining_shift) -
                          (avm_main_abs_da_rem_gas_hi * FF(65536))) -
