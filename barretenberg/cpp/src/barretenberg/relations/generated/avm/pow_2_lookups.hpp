 ...
 *
 */
class pow_2_lookups_lookup_settings {
  public:
    /**
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.pow_2_lookups,
                                     in.pow_2_lookups_counts,
                                     in.avm_alu_pow_2_sel,
                                     in.avm_main_sel_rng_8,
                                     in.avm_alu_ib,
                                     in.avm_alu_two_pow_b,
                                     in.avm_main_clk,
...
template <typename FF_> using pow_2_lookups_relation = GenericLookupRelation<pow_2_lookups_lookup_settings, FF_>;
template <typename FF_> using pow_2_lookups = GenericLookup<pow_2_lookups_lookup_settings, FF_>;
