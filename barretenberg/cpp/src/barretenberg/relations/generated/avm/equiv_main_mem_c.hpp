...
class equiv_main_mem_c_permutation_settings {
  public:
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.equiv_main_mem_c,
...
using equiv_main_mem_c_relation = GenericPermutationRelation<equiv_main_mem_c_permutation_settings, FF_>;
template <typename FF_> using equiv_main_mem_c = GenericPermutation<equiv_main_mem_c_permutation_settings, FF_>;
