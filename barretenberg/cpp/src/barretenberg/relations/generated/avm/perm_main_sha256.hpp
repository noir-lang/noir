...
class perm_main_sha256_permutation_settings {
  public:
    ...
    {
        return (in.avm_main_sel_op_sha256 == 1 || in.avm_sha256_sha256_compression_sel == 1);
    }
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.perm_main_sha256,
                                     in.avm_main_sel_op_sha256,
                                     in.avm_main_sel_op_sha256,
                                     in.avm_sha256_sha256_compression_sel,
                                     in.avm_main_clk,
                                     in.avm_main_ia,
                                     in.avm_main_ib,
                                     in.avm_main_ic,
...
using perm_main_sha256_relation = GenericPermutationRelation<perm_main_sha256_permutation_settings, FF_>;
