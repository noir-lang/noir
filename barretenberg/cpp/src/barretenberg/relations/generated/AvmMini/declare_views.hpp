...
#define AvmMini_DECLARE_VIEWS(index)                                                                                   \
    ...
    [[maybe_unused]] auto aluChip_alu_op_eq = View(new_term.aluChip_alu_op_eq);                                        \
    ...
    [[maybe_unused]] auto aluChip_alu_inv_diff = View(new_term.aluChip_alu_inv_diff);                                  \
    ...
    [[maybe_unused]] auto avmMini_sel_op_eq = View(new_term.avmMini_sel_op_eq);                                        \
