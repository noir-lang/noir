...
template <typename Arithmetization> bool UltraCircuitBuilder_<Arithmetization>::check_circuit()
{
    ...
    for (size_t i = 0; i < this->num_gates; i++) {
        ...
        q_arith_value = blocks.main.q_arith()[i];
        q_aux_value = blocks.main.q_aux()[i];
        q_elliptic_value = blocks.main.q_elliptic()[i];
        q_sort_value = blocks.main.q_sort()[i];
        q_lookup_type_value = blocks.main.q_lookup_type()[i];
        q_1_value = blocks.main.q_1()[i];
        q_2_value = blocks.main.q_2()[i];
        q_3_value = blocks.main.q_3()[i];
        q_4_value = blocks.main.q_4()[i];
        q_m_value = blocks.main.q_m()[i];
        q_c_value = blocks.main.q_c()[i];
        w_1_value = this->get_variable(blocks.main.w_l()[i]);
        update_tag_check_information(blocks.main.w_l()[i], w_1_value);
        w_2_value = this->get_variable(blocks.main.w_r()[i]);
        update_tag_check_information(blocks.main.w_r()[i], w_2_value);
        w_3_value = this->get_variable(blocks.main.w_o()[i]);
        update_tag_check_information(blocks.main.w_o()[i], w_3_value);
        w_4_value = this->get_variable(blocks.main.w_4()[i]);
        // We need to wait before updating tag product for w_4
        w_4_index = blocks.main.w_4()[i];
        ...
        if (i < (this->num_gates - 1)) {
            ...
            w_4_shifted_value = this->get_variable(blocks.main.w_4()[i + 1]);
        } else {
