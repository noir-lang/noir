...
impl FuzzerBuilder {
    ...
    pub fn compile(self, skip_remove_unreachable: bool) -> Result<CompiledProgram, FuzzerBuilderError> {
        let result = std::panic::catch_unwind(AssertUnwindSafe(|| {
            compile(self.builder, &CompileOptions::default(), skip_remove_unreachable)
        }));
        match result {
