...
pub(crate) fn parse_toml(
    ...
    {
        let return_value =
            InputValue::try_from_toml(toml_return_value.clone(), &return_type.0, MAIN_RETURN_NAME)?;
...
pub(crate) fn serialize_to_toml(
    ...
    {
        let return_value = TomlTypes::try_from_input_value(return_value, &return_type.0)?;
