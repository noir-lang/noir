...
library Constants {
  ...
  uint256 internal constant KEY_VALIDATION_REQUEST_AND_GENERATOR_LENGTH =
    KEY_VALIDATION_REQUEST_LENGTH + 1;
  uint256 internal constant SCOPED_KEY_VALIDATION_REQUEST_AND_GENERATOR_LENGTH =
  ...
  uint256 internal constant SCOPED_LOG_HASH_LENGTH = LOG_HASH_LENGTH + 1;
  uint256 internal constant ENCRYPTED_LOG_HASH_LENGTH = 4;
  uint256 internal constant SCOPED_ENCRYPTED_LOG_HASH_LENGTH = ENCRYPTED_LOG_HASH_LENGTH + 1;
  ...
  uint256 internal constant PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = CALL_CONTEXT_LENGTH /*argsHash + returnsHash*/
    + 2 + (READ_REQUEST_LENGTH * MAX_NOTE_HASH_READ_REQUESTS_PER_CALL)
    + (READ_REQUEST_LENGTH * MAX_NULLIFIER_READ_REQUESTS_PER_CALL)
