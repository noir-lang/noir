use low_level_std_lib::{LowLevelStandardLibrary, HashLibrary};
use noir_evaluator::Witness;
use noir_evaluator::{GadgetCall, GadgetInput};
...
impl GadgetCaller {
    pub fn solve_gadget_call<'a>(
        ...
        match gadget_call.name {
            ...
            LowLevelStandardLibrary::Hash(HashLibrary::AES) => {
