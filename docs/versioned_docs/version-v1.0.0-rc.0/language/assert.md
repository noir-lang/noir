...
Aside string literals, the optional message can be a format string or any other type supported as input for Noir's [print](../libraries/standard_library/logging.md) functions. This feature lets you incorporate runtime variables into your failed assertion logs:
...
Like `assert`, the message can be a format string or any other type supported as input for Noir's [print](../libraries/standard_library/logging.md) functions.
