...
pub fn function_with_where<T>(_x: T) where T: SomeTrait<i32> {
    comptime
    {
...
```
> <sup><sub><a href="https://github.com/noir-lang/noir/blob/master/test_programs/compile_success_empty/comptime_type/src/main.nr#L162-L173" target="_blank" rel="noopener noreferrer">Source code: test_programs/compile_success_empty/comptime_type/src/main.nr#L162-L173</a></sub></sup>
