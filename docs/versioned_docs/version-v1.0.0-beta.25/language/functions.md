...
By default, functions are visible only within the package they are defined. To make them visible outside of that package (for example, as part of a [library](../project_structure/crates_and_packages.md#libraries)), you should mark them as `pub`:
