...
This is what [traits](./traits.md) are for in Noir. Here's an example of a function generic over
...
You can find more details on traits and trait implementations on the [traits page](./traits.md).
