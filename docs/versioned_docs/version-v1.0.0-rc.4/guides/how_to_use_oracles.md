...
- You have read the [explainer on Oracles](./oracles.md) and are comfortable with the concept.
...
- An unconstrained method - This tells the compiler that it is executing an [unconstrained function](../language/unconstrained.md).
...
As explained in the [Oracle Explainer](./oracles.md), this `main` function is unsafe unless you constrain its return value. For example:
