...
except vectors whose length is unknown and thus defaulted to zero.
...
```
> <sup><sub><a href="https://github.com/noir-lang/noir/blob/master/noir_stdlib/src/cmp.nr#L5-L9" target="_blank" rel="noopener noreferrer">Source code: noir_stdlib/src/cmp.nr#L5-L9</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/noir-lang/noir/blob/master/noir_stdlib/src/cmp.nr#L242-L246" target="_blank" rel="noopener noreferrer">Source code: noir_stdlib/src/cmp.nr#L242-L246</a></sub></sup>
