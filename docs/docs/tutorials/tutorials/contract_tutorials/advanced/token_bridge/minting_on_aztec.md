...
To mint tokens privately, `claim_private` calls an internal function `_call_mint_on_token()` which then calls [token.mint_private()](/tutorials/tutorials/contract_tutorials/token_contract.md#redeem_shield).
