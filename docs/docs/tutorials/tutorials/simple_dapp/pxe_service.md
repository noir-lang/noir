...
During the Sandbox phase, this role is fulfilled by the [Aztec Sandbox](/reference/reference/sandbox_reference/index.md), which runs a local PXE and an Aztec Node, both connected to a local Ethereum development node like Anvil.
