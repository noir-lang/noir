...
For some hashes there is further domain-separation. For example, [Merkle tree hashing](/aztec/aztec/concepts/storage/trees/index.md#layers) of the tree.
...
- Expanding a random seed to generate additional randomness.
  - See the derivation of [master secret keys](/aztec/aztec/concepts/accounts/keys.md#master-keys).
- Deriving a nullifier, and siloing a nullifier.
  - See [deriving a nullifier](/aztec/aztec/concepts/accounts/keys.md#deriving-a-nullifier-within-an-app-contract).
