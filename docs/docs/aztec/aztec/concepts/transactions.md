...
_The sequencer has received the transaction proof and can begin to process the transaction - verifying proofs and applying updates to the relevant [data trees](/aztec/aztec/concepts/storage/trees/index.md) - alongside other public and private transactions._
...
See the page on [contract communication](/aztec/aztec/concepts/smart_contracts/communication/index.md) for more context on transaction execution.
