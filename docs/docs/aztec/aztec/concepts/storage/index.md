...
The siloing is performed by the [Kernel circuits](/aztec/aztec/concepts/circuits). 
...
For an example of this see [developer documentation storage slots](/aztec/aztec/concepts/storage/index.md).
