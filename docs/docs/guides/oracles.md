...
Another interesting use case is to defer expensive calculations to be made outside of the Noir program, and then constraining the result; similar to the use of [unconstrained functions](../language/unconstrained.md).
...
If you want to build using oracles, follow through to the [oracle guide](./how_to_use_oracles.md) for a simple example on how to do that.
