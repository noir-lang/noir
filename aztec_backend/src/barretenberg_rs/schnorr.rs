...
impl Barretenberg {
    pub fn construct_signature(&mut self, message : &[u8], private_key : [u8;32]) -> [u8;64] {
        ...
        self.call_multiple("construct_signature", vec![&Value::I32(96), &message_len, &Value::I32(64), &Value::I32(0), &Value::I32(32)]);
    ...
    pub fn verify_signature(&mut self,pub_key : [u8;64], sig : [u8;64], message : &[u8]) -> FieldElement {
        ...
        let wasm_value = self.call_multiple("verify_signature", vec![&Value::I32(128), &Value::I32(message.len() as i32), &Value::I32(0), &Value::I32(64), &Value::I32(96)]);
